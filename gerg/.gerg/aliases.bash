...
alias ioanyoutube='youtube-dl -f "bestvideo[ext=mp4]+best[filesize<400M]" --dateafter now-2weeks --match-filter "duration > 180 & duration < 3700" --max-downloads 5 -o "%(autonumber)2d-%(title)s.%(ext)s"'
